...
@export var id: String = "blessing_placeholder"
...
@export_enum("passive", "on_fire", "on_projectile_spawned", "on_hit", "on_kill", "on_room_clear", "on_hurt", "on_gold_changed", "on_low_health", "on_statue_triggered") var trigger_event: String = "passive"
