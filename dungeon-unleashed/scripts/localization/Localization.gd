...
const MESSAGES := {
	...
	"Refraction Crown": "折光冠冕", "Perpetual Dynamo": "永动机芯", "Blackstar Relay": "黑星继电器",
	...
	"Guard": "格挡", "None": "无", "Unknown": "未知", "Fixed": "固定", "Rating": "评级", "Maxed": "已满级",
	...
	"Fire two additional projectiles with every shot.": "每次射击额外发射 2 枚弹丸。",
	"Increase maximum energy by 7 and restore the same amount.": "能量上限提高 7 点，并恢复等量能量。",
	"Chain attacks jump to two additional targets.": "连锁攻击额外跳跃 2 个目标。",
	...
	"+2 projectiles per shot": "每次射击弹丸 +2", "+7 maximum energy": "能量上限 +7", "+2 chain targets": "连锁目标 +2",
